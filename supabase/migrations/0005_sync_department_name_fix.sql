-- ============================================================================
-- MKH Property — 0005: capture department_name from HR sync payloads
--
-- Companion fix to MK Connect's 0060_sync_branch_department_fix.sql. Once
-- MK Connect's payroll/hr_expense triggers started sending a resolved
-- branch_name (this migration doesn't need to change that part — sync_inbound
-- already read payload->>'branch_name' correctly, it just never received a
-- value) they also began sending department_name, which sync_inbound did not
-- yet extract into the pengajuan.data payload. Add it.
-- ============================================================================
