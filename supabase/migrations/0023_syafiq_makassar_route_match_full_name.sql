-- ============================================================================
-- MKH Property — 0023: Broaden the Syafiq-name match for Vando-approval routing
--
-- Employee record is "Muhammad Syafiq" -- 0022's 'Pelapor: Syafiq%' prefix
-- match would miss that and silently route back to Makassar's own
-- (nonexistent) Kepala Cabang instead of Vando. Matches "Syafiq" anywhere
-- in created_by instead, regardless of what name variant he types in the
-- no-login report form.
-- ============================================================================
